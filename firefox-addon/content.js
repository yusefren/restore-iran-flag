...
(function() {
  ...
  const ORIGINAL_FLAG_SVG = browser.runtime.getURL('flag.svg');
  const ORIGINAL_FLAG_PNG = browser.runtime.getURL('flag.png');
  ...
  function isIranFlag(src) {
    ...
    if (src.startsWith('moz-extension://')) return false;
