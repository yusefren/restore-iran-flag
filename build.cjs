...
function buildPage(lang, t) {
  ...
  // Use language-specific og image
  const ogImageSuffix = lang === 'en' ? '' : `-${lang}`;
  const ogImage = `${data.assets.siteUrl}/og-image${ogImageSuffix}.png`;
...
fs.cpSync('og-image.png', 'dist/og-image.png');
fs.cpSync('og-image-ar.svg', 'dist/og-image-ar.svg');
fs.cpSync('og-image-ar.png', 'dist/og-image-ar.png');
fs.cpSync('og-image-fa.svg', 'dist/og-image-fa.svg');
fs.cpSync('og-image-fa.png', 'dist/og-image-fa.png');
